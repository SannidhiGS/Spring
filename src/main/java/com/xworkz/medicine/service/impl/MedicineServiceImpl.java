...
public class MedicineServiceImpl implements MedicineService {
    ...
    public MedicineDTO getMedicineName(String medicineName) throws Exception {

        if (medicineName == null || medicineName.isEmpty()) {
            throw new Exception("Medicine name is invalid");
        }
    ...
    @Override
    public MedicineDTO getMedicineId(int medicineId) throws Exception {
        if(medicineId==0){
            throw new Exception("Medicine id is not valid");
        }
    ...
    public boolean updateMedicine(MedicineDTO medicineDTO) throws Exception {
        ...
        return this.medicineDAO.validAndUpdate(medicineDTO);
    }
}
